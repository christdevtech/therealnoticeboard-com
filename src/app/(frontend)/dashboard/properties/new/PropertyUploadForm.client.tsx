          ...
          <div className="space-y-6">
            ...
            {formData.propertyType === 'residential' && (
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">Residential Features</h3>
            ...
            {formData.propertyType === 'commercial' && (
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">Commercial Features</h3>
            ...
            {formData.propertyType === 'industrial' && (
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">Industrial Features</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Industrial Type
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange('ceilingHeight', parseFloat(e.target.value) || undefined)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="e.g., 6.5"
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('powerSupply', e.target.value || undefined)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            {formData.propertyType === 'land' && (
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900">Land Features</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Land Type
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('landType', e.target.value || undefined)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('topography', e.target.value || undefined)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
